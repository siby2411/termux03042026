...
<head>
    ...
    <title>Gestion Restaurant - La Bonne Cuisine</title>
    ...
    <style>
        * { 
        ...
        /* Badges spécialités */
        .badge-vegetarien { background: #27ae60; color: white; }
        .badge-epice-doux { background: #3498db; color: white; }
        .badge-epice-moyen { background: #f39c12; color: white; }
        .badge-epice-fort { background: #e74c3c; color: white; }
        .badge-featured { background: #9b59b6; color: white; }
    ...
    <div class="header">
        <div class="header-content">
            ...
            <nav class="nav">
                ...
                <a href="plats.php" class="<?= basename($_SERVER['PHP_SELF']) == 'plats.php' ? 'active' : '' ?>">
                    🍽️ Carte
                </a>
