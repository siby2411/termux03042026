...
// Récupération des informations de l'étudiant et de sa photo
...
// On utilise directement le chemin stocké en base (ex: uploads/photos/...)
// Si le champ est vide, on utilise une image par défaut
$img_src = !empty($e['photo_path']) ? htmlspecialchars($e['photo_path']) : 'assets/default_avatar.png';
?>
<!DOCTYPE html>
<html lang="fr">
<head>
    <meta charset="UTF-8">
    <title>Carte Étudiant - OMEGA</title>
    <style>
        ...
        .brand-name { font-family: 'Arial Black', sans-serif; font-size: 14px; text-align: center; color: #ffffff; letter-spacing: 1px; margin-bottom: 20px; text-transform: uppercase; }
        .photo-frame { width: 110px; height: 110px; border-radius: 12px; border: 3px solid #ffffff; object-fit: cover; box-shadow: 0 5px 15px rgba(0,0,0,0.2); background: #f8f9fa; }
        ...
        .code-id { background: #0d47a1; color: white; padding: 4px 10px; border-radius: 5px; font-family: monospace; margin-top: 10px; font-size: 14px; }
...
<div class="badge-card">
    <div class="left-side">
        ...
        <img src="<?= $img_src ?>" class="photo-frame" alt="Photo Étudiant">
