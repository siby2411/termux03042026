...
// Requête robuste : on récupère tout pour éviter les variables vides
...
// Vérification de sécurité : si l'étudiant n'existe pas
if (!$e) {
    die("<h1>Étudiant introuvable</h1><p>Vérifiez l'ID passé dans l'URL.</p>");
}

// Gestion intelligente de l'image (Fallback)
