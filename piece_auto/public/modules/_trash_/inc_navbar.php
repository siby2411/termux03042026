...
function toggleSidebar() {
    ...
    <div class="nav-header text-white-50 small mt-3">📊 ANALYSE BILANTAIRE</div>
    <div class="nav-item"><a class="nav-link" href="analyse_bilan_zscore.php">📈 Lecture verticale/horizontale & Z-Score</a></div>
    <div class="nav-header text-white-50 small mt-3">📊 RETRAITEMENTS SYSCOSYSCOHADA</div>
    <div class="nav-item"><a class="nav-link" href="balance_retraitee.php">⚙️ Balance retraitée & ajustements</a></div>
    <div class="nav-header text-white-50 small mt-3">🔍 AUDIT & RISQUES</div>
    <div class="nav-item"><a class="nav-link" href="audit_risques.php">📋 Cartographie & Heat Map COSO II</a></div>
    <div class="nav-header text-white-50 small mt-3">📘 FORMATION AUDIT</div>
    <div class="nav-item"><a class="nav-link" href="manuel_formation_audit.php">📚 Manuel audit & contrôle interne</a></div>
    <div class="nav-header text-white-50 small mt-3">🏭 CONTRÔLE DE GESTION</div>
    <div class="nav-item"><a class="nav-link" href="controle_gestion_multidimensionnel.php">📊 Centres de profit & prix de transfert</a></div>
    <div class="nav-header text-white-50 small mt-3">📊 OPTIMISATION STRATÉGIQUE</div>
    <div class="nav-item"><a class="nav-link" href="optimisation_bcg_simplexe.php">🎯 BCG & Simplexe pondéré</a></div>
    <div class="nav-header text-white-50 small mt-3">🏆 MANAGEMENT STRATÉGIQUE</div>
    <div class="nav-item"><a class="nav-link" href="charte_management_qualite.php">📋 Charte de management & outils stratégiques</a></div>
    <div class="nav-header text-white-50 small mt-3">🐟 GESTION BUDGÉTAIRE</div>
    <div class="nav-item"><a class="nav-link" href="gestion_budgetaire_halieutique.php">📊 Sen-Pêche SA – Budget & seuil rentabilité</a></div>
    <div class="nav-header text-white-50 small mt-3">📚 FORMATION COMPTABILITÉ</div>
    <div class="nav-item"><a class="nav-link" href="guide_ecritures_comptables.php">📖 Guide écritures SYSCOHADA</a></div>
    <div class="nav-header text-white-50 small mt-3">📚 COMPTABILITÉ AVANCÉE</div>
    <div class="nav-item"><a class="nav-link" href="guide_ecritures_avancees.php">📖 Devises, leasing, analytique</a></div>
    <div class="nav-header text-white-50 small mt-3">🏢 PERFORMANCE & CENTRES</div>
    <div class="nav-item"><a class="nav-link" href="performance_centres_profit.php">📊 Centres de profit & PCI</a></div>
    <div class="nav-header text-white-50 small mt-3">🏷️ PRIX DE CESSION INTERNE</div>
    <div class="nav-item"><a class="nav-link" href="formation_prix_cession.php">📊 Formation PCI & arbitrage</a></div>
    <div class="nav-header text-white-50 small mt-3">📋 PLAN COMPTABLE</div>
    <div class="nav-item"><a class="nav-link" href="recherche_comptes_par_classe.php">📊 Comptes par classe SYSCOHADA</a></div>
    <div class="nav-header text-white-50 small mt-3">📚 FORMATION COMPTABLE</div>
    <div class="nav-item"><a class="nav-link" href="guide_formation_ecritures_comptables.php">📖 Guide écritures SYSCOHADA (algorithme)</a></div>
    <div class="nav-header text-white-50 small mt-3">📊 RETRAITEMENTS COMPTABLES</div>
    <div class="nav-item"><a class="nav-link" href="retraitement_comptable.php">🔄 Leasing & retraitements (analyse financière)</a></div>
    <div class="nav-header text-white-50 small mt-3">📊 RETRAITEMENTS AVANCÉS</div>
    <div class="nav-item"><a class="nav-link" href="retraitement_approfondi.php">📈 Bilan, BFR, CAF & analyse financière</a></div>
    </div>
