...
<body>
    <div class="navbar">
        <div class="container">
            <h3><i class="fas fa-archive"></i> Secrétariat - <?= htmlspecialchars($user['prenom'] . ' ' . $user['nom']) ?></h3>
    ...
    <div class="container">
        <div class="actions-grid">
            ...
            <div class="action-card" onclick="window.location.href='../patients/liste.php'">
                <div class="action-icon"><i class="fas fa-users"></i></div>
                <h6>Gestion Patients</h6>
                <small>Liste et ajout</small>
            </div>
            <div class="action-card" onclick="window.location.href='../rendezvous/liste.php'">
                <div class="action-icon"><i class="fas fa-calendar-alt"></i></div>
                <h6>Rendez-vous</h6>
                <small>Planning du jour</small>
            </div>
        </div>
    </div>
</body>
            ...
            <div class="action-card" onclick="window.location.href='documents.php'">
                ...
                <h6>Gestion Documents</h6>
                <small>Upload, partage, archivage</small>
            </div>
            <div class="action-card" onclick="window.location.href='rapports.php'">
                <div class="action-icon"><i class="fas fa-chart-bar"></i></div>
                <h6>Rapports</h6>
                <small>Génération automatique</small>
            </div>
