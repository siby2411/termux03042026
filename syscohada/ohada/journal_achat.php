...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['ajouter'])) {
    ...
    $stmt = $conn->prepare("INSERT INTO journal_achats (date_operation, description, montant) VALUES (?, ?, ?)");
...
if (isset($_GET['supprimer'])) {
    $id = $_GET['supprimer'];
    $stmt = $conn->prepare("DELETE FROM journal_achats WHERE id = ?");
...
$result = $conn->query("SELECT * FROM journal_achats ORDER BY date_operation DESC");
