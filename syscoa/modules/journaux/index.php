...
// Journaliser l'accès
logger_action("Accès module journaux", "Exercice: " . $exercice['libelle']);
...
<div class="row mb-4">
    <div class="col-12">
        <h2>
            <i class="bi bi-<?php echo $icones['journaux']; ?>"></i>
            <?php echo $titres['journaux']; ?>
        </h2>
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0">Module <?php echo $titres['journaux']; ?></h5>
