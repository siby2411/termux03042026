...
// Journaliser l'accès
logger_action("Accès module budget", "Exercice: " . $exercice['libelle']);
...
<div class="row mb-4">
    <div class="col-12">
        <h2>
            <i class="bi bi-<?php echo $icones['budget']; ?>"></i>
            <?php echo $titres['budget']; ?>
        </h2>
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0">Module <?php echo $titres['budget']; ?></h5>
