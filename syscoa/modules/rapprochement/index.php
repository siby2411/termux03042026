...
// Journaliser l'accès
logger_action("Accès module rapprochement", "Exercice: " . $exercice['libelle']);
...
<div class="row mb-4">
    <div class="col-12">
        <h2>
            <i class="bi bi-<?php echo $icones['rapprochement']; ?>"></i>
            <?php echo $titres['rapprochement']; ?>
        </h2>
...
<?php elseif ('rapprochement' == 'soldes'): ?>
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0">Module <?php echo $titres['rapprochement']; ?></h5>
