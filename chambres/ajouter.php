...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$numero || !$prix_nuit) {
        $error = "Numéro et prix obligatoires.";
    } else {
        try {
...
<body>
    ...
    <div class="container mt-4">
        ...
        <form method="post">
            <div class="row">
                <div class="col-md-4 mb-3"><label>Numéro *</label><input type="text" name="numero" class="form-control" required></div>
                ...
                <div class="col-12 mb-3"><label>Équipements</label><textarea name="equipements" class="form-control" rows="2"></textarea></div>
            </div>
