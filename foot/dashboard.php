...
// Nouvelles statistiques : terrain et salle
$stats['total_terrains'] = $pdo->query("SELECT COUNT(*) FROM terrain")->fetchColumn();
$stats['terrains_disponibles'] = $pdo->query("SELECT COUNT(*) FROM terrain WHERE disponibilite = 'libre'")->fetchColumn();
$stats['total_salles'] = $pdo->query("SELECT COUNT(*) FROM salle")->fetchColumn();
$stats['salles_disponibles'] = $pdo->query("SELECT COUNT(*) FROM salle WHERE disponibilite = 'libre'")->fetchColumn();

// Meilleure vente (optionnel)
    ...
    <div class="col-md-2">
        <div class="card bg-secondary text-white">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h6 class="card-title">Terrains</h6>
                        <h2 class="mb-0"><?php echo $stats['total_terrains']; ?></h2>
                        <small>Disponibles: <?php echo $stats['terrains_disponibles']; ?></small>
                    </div>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h2 class="mb-0"><?php echo $stats['total_salles']; ?></h2>
                        <small>Disponibles: <?php echo $stats['salles_disponibles']; ?></small>
                    </div>
                    ...
                    <table class="table table-sm">
                        <thead>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><?php echo $vente['numero_facture']; ?>\(n
                                    <td><?php echo date('d/m/Y H:i', strtotime($vente['date_vente'])); ?>\(n
                                    <td><?php echo $vente['caissier']; ?>\(n
                                    <td><?php echo number_format($vente['montant_total'], 0, ',', ' '); ?> FCFA\(n
                                    <td>
