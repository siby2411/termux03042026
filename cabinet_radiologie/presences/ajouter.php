...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$personnel_id || !$date || !$heure_arrivee) {
        ...
        try {
            ...
            $stmt->execute([$personnel_id, $date, $heure_arrivee, $heure_depart ?: null, $present]);
...
<!DOCTYPE html>
<html lang="fr">
<head><meta charset="UTF-8"><title>Ajouter présence</title><link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet"></head>
<body>
    ...
    <div class="container mt-4">
        ...
        <form method="post">
            ...
            <div class="form-check mb-3"><input type="checkbox" name="present" class="form-check-input" checked> <label>Présent</label></div>
