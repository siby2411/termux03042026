...
<aside class="sidebar">
  ...
  <nav class="sidebar-nav">
    ...
    <a href="logout.php">
      ...
      <div class="nav-section">Services Premium</div>
    <a href="caisse_pos.php"><span class="icon"><i class="fas fa-cash-register"></i></span> Caisse POS Tactile</a>
    <a href="promotions.php"><span class="icon"><i class="fas fa-tags"></i></span> Promotions &amp; Fidélité</a>
    <a href="inventaire.php"><span class="icon"><i class="fas fa-clipboard-list"></i></span> Inventaire Physique</a>
    <a href="dlc.php"><span class="icon"><i class="fas fa-calendar-times"></i></span> Gestion DLC / DLUO</a>
    <a href="alertes.php"><span class="icon"><i class="fas fa-bell"></i></span> Alertes &amp; Notif.</a>
...
<?php endif; ?>
<!-- SIDEBAR MODULES PREMIUM AJOUTÉS VIA PATCH -->
