...
// Récupérer les produits pour les listes déroulantes dynamiques (Code, Prix)
$produits = [];
...
<head>
    <meta charset="UTF-8">
    <title>Création Document de Vente</title>
    </head>
<body>
    ...
    <script>
        ...
        function ajouterLigne() {
            ...
            // Cellule 1: Sélection du Produit
            ...
            // Cellule 3: Prix Unitaire (Lecture seule)
            const cell3 = newRow.insertCell();
            cell3.innerHTML = `<input type="number" name="produits[${rowCount}][prix_unitaire]" step="0.01" value="0.00" readonly style="width: 80px;">`;
        ...
        function updateRow(rowId) {
            ...
            // Mettre à jour le champ Prix Unitaire (lecture seule)
