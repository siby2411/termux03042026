#!/bin/bash
# ============================================================
# SCRIPT 07 — INSTALLATION COMPLÈTE & DÉPLOIEMENT
# Termux / proot-distro / Ubuntu / MariaDB / PHP / Apache
# ============================================================

BASE="$HOME/shared/htdocs/apachewsl2026"

cat << 'INSTALL_EOF' > "$BASE/INSTALL.md"
...
echo "✅ Guide INSTALL.md généré"

# ─────────────────────────────────────────────────────────────
# 7.2 Script de vérification post-déploiement
# ─────────────────────────────────────────────────────────────
cat << 'EOF' > "$BASE/check_deploy.sh"
#!/bin/bash
# ============================================================
