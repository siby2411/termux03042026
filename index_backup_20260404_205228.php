...
$apps = [
    ...
    "Portail E-Commerce" => [
        "url" => "proxy.php?app=portail",
        "logo" => "🛍️",
        "color" => "#e84393",
        "description" => "Plateforme e-commerce, commandes, clients et fournisseurs",
        "category" => "commerce"
    ],
    ...
    "Banque & Trésorerie" => [
        "url" => "banque/public/login.php",
        "logo" => "🏦",
        "color" => "#2ecc71",
        "description" => "Gestion des comptes bancaires, flux de trésorerie et rapprochement.",
        "category" => "finance"
    ],
    "Gestion Prévisionnelle" => [
        "url" => "gestion_previsionnelle/",
        "logo" => "📈",
        "color" => "#f1c40f",
        "description" => "Planification budgétaire, prévisions et simulations financières.",
        "category" => "finance"
    ],

    // === Applications Santé ===
    "Centre de Santé" => [
        "url" => "proxy.php?app=centrediop",
        "logo" => "🏥",
        "color" => "#3498db",
        "description" => "Gestion de clinique, patients, consultations et facturation.",
        "category" => "health"
    ],
    "Analyse Médicale" => [
        "url" => "proxy.php?app=analyse_medicale",
        "logo" => "🔬",
        "color" => "#16a085",
        "description" => "Laboratoire d'analyses médicales, résultats et comptes rendus.",
        "category" => "health"
    ],
    "Cabinet Radiologie" => [
        "url" => "proxy.php?app=cabinet_radiologie",
        "logo" => "🩻",
        "color" => "#3498db",
        "description" => "Gestion de cabinet radiologique, examens et comptes rendus.",
        "category" => "health"
    ],
    "Pharmacie" => [
        "url" => "proxy.php?app=pharmacie",
        "logo" => "💊",
        "color" => "#1abc9c",
        "description" => "Médicaments, stocks, ordonnances.",
        "category" => "health"
    ],
    "Revendeur Médical" => [
        "url" => "proxy.php?app=revendeur_medical",
        "logo" => "🚚",
        "color" => "#e74c3c",
        "description" => "Distribution de matériel médical, facturation.",
        "category" => "health"
    ],

    // === Applications Commerce Spécialisé ===
    "Charcuterie" => [
        "url" => "proxy.php?app=charcuterie2",
        "logo" => "🥩",
        "color" => "#e67e22",
        "description" => "Gestion des produits, stocks et commandes.",
        "category" => "commerce"
    ],
    "Librairie" => [
        "url" => "proxy.php?app=librairie",
        "logo" => "📚",
        "color" => "#9b59b6",
        "description" => "Gestion de livres, auteurs et ventes.",
        "category" => "commerce"
    ],

    // === Applications Sport ===
    "Gestion Foot" => [
        "url" => "proxy.php?app=foot",
        "logo" => "⚽",
        "color" => "#27ae60",
        "description" => "Club, joueurs, matchs et compétitions.",
        "category" => "sport"
    ],

    // === Applications Hôtellerie ===
    "Gestion Hôtelière" => [
        "url" => "hotel/",
        "logo" => "🏨",
        "color" => "#f1c40f",
        "description" => "Réservations, chambres, facturation et gestion hôtelière.",
        "category" => "business"
    ],

    // === Applications Mode ===
    "Couture Senegal" => [
        "url" => "proxy.php?app=couture_senegal",
        "logo" => "👗",
        "color" => "#ff6b6b",
        "description" => "Gestion de boutique de couture, commandes, clients et stocks.",
        "category" => "commerce"
    ],

    // === Applications BTP ===
    "Génie Civil" => [
        "url" => "proxy.php?app=genie_civil",
        "logo" => "🏗️",
        "color" => "#e67e22",
        "description" => "Gestion de projets BTP, matériaux, chantiers et devis.",
        "category" => "business"
    ],

    // === Applications Transport ===
    "Transit & Logistique" => [
        "url" => "proxy.php?app=transit",
        "logo" => "🚚",
        "color" => "#3498db",
        "description" => "Gestion de transit, transport, marchandises et douane.",
        "category" => "business"
    ],

    // === Applications Tourisme ===
    "Agence Voyage" => [
        "url" => "proxy.php?app=agence_voyage",
        "logo" => "✈️",
        "color" => "#2ecc71",
        "description" => "Réservations billets, circuits touristiques, hôtels et clients.",
        "category" => "business"
    ],

    // === Applications Immobilier ===
    "Gestion Immobilière" => [
        "url" => "proxy.php?app=gestion_immobiliere",
        "logo" => "🏢",
        "color" => "#2c3e50",
        "description" => "Gestion de biens, locations, contrats et facturation.",
        "category" => "business"
    ],
];
...
$categories = [
    ...
    "health"        => ["icon" => "🏥", "name" => "Santé", "color" => "#e74c3c"],
    "sport"         => ["icon" => "⚽", "name" => "Sport", "color" => "#27ae60"],
...
<head>
    ...
    <title>Omega Business Suite - Portail Applications Professionnelles</title>
    ...
    <style>
        ...
        @media (max-width: 768px) {
            ...
            .category-badge { font-size: 0.8rem; padding: 0.4rem 0.8rem; }
        }
    </style>
</head>
<body>
    <div class="header-section">
        <div class="container">
            <h1 class="header-title">Omega Business Suite</h1>
            <p class="header-subtitle">Écosystème complet de solutions professionnelles</p>
            ...
            <?php foreach($apps as $name => $app): ?>
                <div class="col-xl-3 col-lg-4 col-md-6 app-item" data-category="<?= $app['category'] ?>">
                    <div class="glass-card h-100">
                        <a href="<?= $app['url'] ?>" class="app-card" style="--card-color: <?= $app['color'] ?>" target="_blank">
                            <?php if(in_array($name, ['Gestion Auto', 'Restauration', 'Pressing', 'E-commerce', 'Analyse Médicale', 'Portail E-Commerce'])): ?>
    ...
    <footer class="text-center py-4 text-white">
        <div class="container">
            <p class="mb-0">&copy; 2026 Omega Business Suite. Écosystème complet de solutions.</p>
            <p class="text-white-50 small">Développé par Mohamed Siby - Consultant en Informatique</p>
        </div>
    </footer>
